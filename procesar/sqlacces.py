...
# Connection parameters for dw_fz with Windows

server = "192.168.50.38\DW_FZ"
database = 'Analitica'
# database = 'DW_FZ'
driver = f'{pyodbc.drivers()[0]}'  # Ensure the correct driver is installed
connection_windows_dw_fz = f"mssql+pyodbc://{server}/{database}?driver={driver}&TrustServerCertificate=yes&Trusted_Connection=yes"